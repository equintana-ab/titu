(function () {
  // Bail out if the markup isn't on the page, or if this script already ran (SPA re-navigation)
  const searchInput = document.getElementById("slStoreSearch");
  if (!searchInput || window.__slStoreLocatorInit) return;
  window.__slStoreLocatorInit = true;
    ...
    return Promise.resolve([
      {
        ...
        mapEmbed:
          "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3859.98104803103!2d121.02098799999999!3d14.657017!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397b6efe428d1ff%3A0xa4887123dd5d2d2f!2sAbenson%20Waltermart%20North%20EDSA!5e0!3m2!1sen!2sph!4v1790215062312!5m2!1sen!2sph",

        mapsQuery: "14.657039952694547,121.02097968047521",
      },
      {
        id: 2,
        name: "Abenson Quezon Avenue",
        addr: "Quezon Avenue, corner Scout Albano Ave, Quezon City, 1103 Metro Manila",
        hours: "11AM to 8PM",
        phones: ["(02) 8441 2200", "0917 555 0199"],
        viberNumber: "639175550199",
        mapEmbed:
          "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d34666.4598805389!2d121.00076967321007!3d14.625368268314594!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397b7a75de1f1eb%3A0xfcb24bf0fff06471!2sAbenson%20Quezon%20Avenue!5e0!3m2!1sen!2sph!4v1790232134064!5m2!1sen!2sph",
        mapsQuery: "14.642986136133816,121.03236974672633",
      },
      {
        id: 3,
        ...
        mapEmbed:
          "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4332.799045883372!2d121.03056953293415!3d14.651108094828578!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397b7028f4df26b%3A0x17ed7b8765cfa69c!2sAbenson!5e0!3m2!1sen!2sph!4v1790232227560!5m2!1sen!2sph",
        mapsQuery: "14.652657689567144,121.03373676591235",
      },
    ]);
  }
  ...
  const getModal = () => document.getElementById("sl-modal");

  function openModal() {
    const modal = getModal();
    if (!modal) return;

    modal.classList.add("sl-show-modal");
  ...
  function closeModal() {
    ...
    modal.classList.remove("sl-show-modal");
  ...
  function renderStores(list) {
    const resultsEl = document.getElementById("slStoreResults");
    resultsEl.innerHTML = "";
    if (!list.length) {
      resultsEl.innerHTML =
        '<p style="font-size:13px;color:var(--sl-muted);padding:10px;">No stores match your search.</p>';
      return;
    }
    list.forEach(function (store) {
      ...
      card.tabIndex = 0;
      card.className = "sl-store-card" + (store.id === activeId ? " sl-is-active" : "");
      card.dataset.id = store.id;

      const phonesHtml = store.phones
        .map(function (num) {
          return '<a class="sl-phone-link" href="' + toTelHref(num) + '">' + num + "</a>";
        })
        .join('<span class="sl-phone-sep"> • </span>');
  ...
  function selectStore(id) {
    ...
    document.querySelectorAll(".sl-store-card").forEach(function (c) {
      c.classList.toggle("sl-is-active", Number(c.dataset.id) === id);
    });

    const mapFrame = document.getElementById("slStoreMapFrame");
    const directionsBtn = document.getElementById("slGetDirectionsBtn");
    const searchingEl = document.getElementById("slSearching");

    // fade the current map out first
    mapFrame.classList.remove("sl-is-visible");

    mapFrame.onload = function () {
      mapFrame.classList.add("sl-is-visible");
      searchingEl.classList.add("sl-is-hidden");
    };
    mapFrame.title = "Map of " + store.name;
    ...
    directionsBtn.classList.add("sl-is-visible");
  }

  function resetToSearching() {
    activeId = null;
    document.querySelectorAll(".sl-store-card").forEach(function (c) {
      c.classList.remove("sl-is-active");
    });
    document.getElementById("slStoreMapFrame").classList.remove("sl-is-visible");
    document.getElementById("slGetDirectionsBtn").classList.remove("sl-is-visible");
    document.getElementById("slSearching").classList.remove("sl-is-hidden");
  }
  ...
  document.addEventListener("click", function (e) {
    ...
    // Open
    if (e.target.closest("#sl-open-button")) {
      openModal();
      return;
    }
    ...
    const viberEl = e.target.closest(".sl-viber-btn");
    if (viberEl) {
      e.stopPropagation();
    ...
    if (e.target.closest(".sl-phone-link")) {
      e.stopPropagation();
      return;
    }

    // Select a store card (generic fallback — must come last)
    const card = e.target.closest(".sl-store-card");
    if (card) {
  ...
  document.addEventListener("click", function (e) {
    const modal = getModal();
    if (e.target.closest(".sl-modal-content") && e.target !== modal) {
      e.stopPropagation();
    }
  });
